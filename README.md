...
| 29/11 | 13:00-15:00 | Parallel algorithms | [The Third Homomorphism Theorem](material/algorithms/lhomo-third-theorem.pdf), [Construction of List Homomorphisms by Tupling and Fusion](material/algorithms/lhomo-tupling.pdf) |
| 01/12 | 10:00-12:00 | [Regular and incremental flattening](slides/L4-regular-flattening.pdf) | [Futhark: Purely Functional GPU-Programming with Nested Parallelism and In-Place Array Updates](https://futhark-lang.org/publications/pldi17.pdf), [Incremental Flattening for Nested Data Parallelism](https://futhark-lang.org/publications/ppopp19.pdf) (particularly the latter) |
...
| 08/12 | 10:00-12:00 | [Halide: Stencil Fusion](slides/L6-Halide.pdf) | [Halide: A Language and Compiler for Optimizing Parallelism, Locality and Recomputation in Image Processing Pipelines](material/halide-pldi13.pdf) |
| 08/12 | 13:00-17:00 | Lab ([**Assignment 3 handout**](weekly-3/)) | |
| 13/12 | 13:00-15:00 | [Vector programming with ISPC](slides/L7-ispc.pdf) | [ispc: A SPMD Compiler for High-Performance CPU Programming](material/ispc_inpar_2012.pdf) | |
